    ...
    <div class="topbar">
      <div class="container">
        <header class="header">
          <div class="brand">
            <img
              src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='64' height='64' viewBox='0 0 64 64'><rect width='64' height='64' rx='16' fill='%23D6B25E'/><path d='M20 42V22h12c6 0 10 4 10 10s-4 10-10 10H20zm8-6h4c3 0 5-2 5-4s-2-4-5-4h-4v8z' fill='%230B1020'/></svg>"
              alt="Marca"
            >
            <div>
              <strong>LP2 TESTE</strong><br>
              <span>Landing page de validação</span>
            </div>
          </div>
          <nav class="nav">
      ...
      <div class="container">
        ...
        <div class="steps">
          <div class="step">
            ...
            <p>Escolha o texto principal e o objetivo do teste.</p>
          </div>
          <div class="step">
            <div class="n">2</div>
